...
.method static synthetic lambda$toImmutableEnumMap$1()Lcom/google/common/collect/Maps$Accumulator;
    ...
    new-instance v1, Lcom/google/common/collect/Maps$$ExternalSyntheticLambda6;

    invoke-direct {v1}, Lcom/google/common/collect/Maps$$ExternalSyntheticLambda6;-><init>()V

    invoke-direct {v0, v1}, Lcom/google/common/collect/Maps$Accumulator;-><init>(Lj$/util/function/BinaryOperator;)V

    return-object v0
.end method

.method static synthetic lambda$toImmutableEnumMap$2(Lj$/util/function/Function;Lj$/util/function/Function;Lcom/google/common/collect/Maps$Accumulator;Ljava/lang/Object;)V
    .locals 3
...
.method static synthetic lambda$toImmutableEnumMap$3(Lj$/util/function/BinaryOperator;)Lcom/google/common/collect/Maps$Accumulator;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lcom/google/common/collect/Maps$Accumulator;-><init>(Lj$/util/function/BinaryOperator;)V

    return-object v0
.end method

.method static synthetic lambda$toImmutableEnumMap$4(Lj$/util/function/Function;Lj$/util/function/Function;Lcom/google/common/collect/Maps$Accumulator;Ljava/lang/Object;)V
    .locals 3
    .param p0, "keyFunction"    # Lj$/util/function/Function;
    .param p1, "valueFunction"    # Lj$/util/function/Function;
    .param p2, "accum"    # Lcom/google/common/collect/Maps$Accumulator;
...
.method public static toImmutableEnumMap(Lj$/util/function/Function;Lj$/util/function/Function;)Lj$/util/stream/Collector;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 229
    new-instance v0, Lcom/google/common/collect/Maps$$ExternalSyntheticLambda4;

    invoke-direct {v0}, Lcom/google/common/collect/Maps$$ExternalSyntheticLambda4;-><init>()V

    new-instance v1, Lcom/google/common/collect/Maps$$ExternalSyntheticLambda5;

    invoke-direct {v1, p0, p1}, Lcom/google/common/collect/Maps$$ExternalSyntheticLambda5;-><init>(Lj$/util/function/Function;Lj$/util/function/Function;)V

    new-instance v2, Lcom/google/common/collect/Maps$$ExternalSyntheticLambda2;

    invoke-direct {v2}, Lcom/google/common/collect/Maps$$ExternalSyntheticLambda2;-><init>()V

    new-instance v3, Lcom/google/common/collect/Maps$$ExternalSyntheticLambda3;

    invoke-direct {v3}, Lcom/google/common/collect/Maps$$ExternalSyntheticLambda3;-><init>()V
...
.method public static toImmutableEnumMap(Lj$/util/function/Function;Lj$/util/function/Function;Lj$/util/function/BinaryOperator;)Lj$/util/stream/Collector;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .local p0, "keyFunction":Lj$/util/function/Function;, "Ljava/util/function/Function<-TT;+TK;>;"
    .local p1, "valueFunction":Lj$/util/function/Function;, "Ljava/util/function/Function<-TT;+TV;>;"
    .local p2, "mergeFunction":Lj$/util/function/BinaryOperator;, "Ljava/util/function/BinaryOperator<TV;>;"
    invoke-static {p0}, Lcom/google/common/base/Preconditions;->checkNotNull(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p2}, Lcom/google/common/collect/Maps$$ExternalSyntheticLambda0;-><init>(Lj$/util/function/BinaryOperator;)V

    new-instance v1, Lcom/google/common/collect/Maps$$ExternalSyntheticLambda1;

    invoke-direct {v1, p0, p1}, Lcom/google/common/collect/Maps$$ExternalSyntheticLambda1;-><init>(Lj$/util/function/Function;Lj$/util/function/Function;)V
