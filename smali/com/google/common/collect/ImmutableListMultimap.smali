...
.method public static flatteningToImmutableListMultimap(Lj$/util/function/Function;Lj$/util/function/Function;)Lj$/util/stream/Collector;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .local p1, "valuesFunction":Lj$/util/function/Function;, "Ljava/util/function/Function<-TT;+Ljava/util/stream/Stream<+TV;>;>;"
    ...
    .line 133
    new-instance v0, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda4;

    invoke-direct {v0, p0}, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda4;-><init>(Lj$/util/function/Function;)V

    new-instance v1, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda5;

    invoke-direct {v1, p1}, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda5;-><init>(Lj$/util/function/Function;)V
    ...
    new-instance v3, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda6;

    invoke-direct {v3, v2}, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda6;-><init>(Lcom/google/common/collect/MultimapBuilder$ListMultimapBuilder;)V

    .line 134
    invoke-static {v0, v1, v3}, Lcom/google/common/collect/Multimaps;->flatteningToMultimap(Lj$/util/function/Function;Lj$/util/function/Function;Lj$/util/function/Supplier;)Lj$/util/stream/Collector;

    move-result-object v0

    new-instance v1, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda7;

    invoke-direct {v1}, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda7;-><init>()V

    .line 133
    invoke-static {v0, v1}, Lj$/util/stream/Collectors;->collectingAndThen(Lj$/util/stream/Collector;Lj$/util/function/Function;)Lj$/util/stream/Collector;
...
.method static synthetic lambda$flatteningToImmutableListMultimap$1(Lj$/util/function/Function;Ljava/lang/Object;)Ljava/lang/Object;
    .locals 1
...
.method static synthetic lambda$flatteningToImmutableListMultimap$2(Lj$/util/function/Function;Ljava/lang/Object;)Lj$/util/stream/Stream;
    .locals 2
    .param p0, "valuesFunction"    # Lj$/util/function/Function;
    .param p1, "input"    # Ljava/lang/Object;
    ...
    new-instance v1, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda8;

    invoke-direct {v1}, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda8;-><init>()V

    invoke-interface {v0, v1}, Lj$/util/stream/Stream;->peek(Lj$/util/function/Consumer;)Lj$/util/stream/Stream;
...
.method static synthetic lambda$toImmutableListMultimap$0(Lj$/util/function/Function;Lj$/util/function/Function;Lcom/google/common/collect/ImmutableListMultimap$Builder;Ljava/lang/Object;)V
    .locals 2
    .param p0, "keyFunction"    # Lj$/util/function/Function;
...
.method public static toImmutableListMultimap(Lj$/util/function/Function;Lj$/util/function/Function;)Lj$/util/stream/Collector;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 88
    new-instance v0, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda0;

    invoke-direct {v0}, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda0;-><init>()V

    new-instance v1, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda1;

    invoke-direct {v1, p0, p1}, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda1;-><init>(Lj$/util/function/Function;Lj$/util/function/Function;)V

    new-instance v2, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda2;

    invoke-direct {v2}, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda2;-><init>()V

    new-instance v3, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda3;

    invoke-direct {v3}, Lcom/google/common/collect/ImmutableListMultimap$$ExternalSyntheticLambda3;-><init>()V
