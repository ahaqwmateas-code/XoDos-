...
.method constructor <init>(Lj$/util/stream/Node$OfInt;Lj$/util/stream/Node$OfInt;)V
    .locals 0
    .param p1, "left"    # Lj$/util/stream/Node$OfInt;
    .param p2, "right"    # Lj$/util/stream/Node$OfInt;
...
.method public bridge synthetic truncate(JJLj$/util/function/IntFunction;)Lj$/util/stream/Node$OfPrimitive;
    ...
    invoke-static/range {p0 .. p5}, Lj$/util/stream/Node$OfInt$-CC;->$default$truncate(Lj$/util/stream/Node$OfInt;JJLj$/util/function/IntFunction;)Lj$/util/stream/Node$OfPrimitive;
