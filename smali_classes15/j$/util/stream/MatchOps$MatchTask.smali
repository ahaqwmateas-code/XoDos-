...
.method constructor <init>(Lj$/util/stream/MatchOps$MatchOp;Lj$/util/stream/PipelineHelper;Lj$/util/Spliterator;)V
    ...
    .line 287
    .local p0, "this":Lj$/util/stream/MatchOps$MatchTask;, "Ljava/util/stream/MatchOps$MatchTask<TP_IN;TP_OUT;>;"
    .local p1, "op":Lj$/util/stream/MatchOps$MatchOp;, "Ljava/util/stream/MatchOps$MatchOp<TP_OUT;>;"
...
.method constructor <init>(Lj$/util/stream/MatchOps$MatchTask;Lj$/util/Spliterator;)V
    ...
    .line 295
    .local p0, "this":Lj$/util/stream/MatchOps$MatchTask;, "Ljava/util/stream/MatchOps$MatchTask<TP_IN;TP_OUT;>;"
    .local p1, "parent":Lj$/util/stream/MatchOps$MatchTask;, "Ljava/util/stream/MatchOps$MatchTask<TP_IN;TP_OUT;>;"
    ...
    .line 296
    iget-object v0, p1, Lj$/util/stream/MatchOps$MatchTask;->op:Lj$/util/stream/MatchOps$MatchOp;

    iput-object v0, p0, Lj$/util/stream/MatchOps$MatchTask;->op:Lj$/util/stream/MatchOps$MatchOp;
...
.method protected doLeaf()Ljava/lang/Boolean;
    ...
    .line 306
    .local p0, "this":Lj$/util/stream/MatchOps$MatchTask;, "Ljava/util/stream/MatchOps$MatchTask<TP_IN;TP_OUT;>;"
    iget-object v0, p0, Lj$/util/stream/MatchOps$MatchTask;->helper:Lj$/util/stream/PipelineHelper;
    ...
    iget-object v2, p0, Lj$/util/stream/MatchOps$MatchTask;->spliterator:Lj$/util/Spliterator;
    ...
    invoke-virtual {p0, v1}, Lj$/util/stream/MatchOps$MatchTask;->shortCircuit(Ljava/lang/Object;)V
