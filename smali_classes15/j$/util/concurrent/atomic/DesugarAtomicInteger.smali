...
.method public static accumulateAndGet(Ljava/util/concurrent/atomic/AtomicInteger;ILj$/util/function/IntBinaryOperator;)I
    .locals 3
    .param p0, "atomic"    # Ljava/util/concurrent/atomic/AtomicInteger;
    .param p1, "x"    # I
    .param p2, "accumulatorFunction"    # Lj$/util/function/IntBinaryOperator;
    ...
    .line 142
    .local v0, "prev":I
    invoke-interface {p2, v0, p1}, Lj$/util/function/IntBinaryOperator;->applyAsInt(II)I
...
.method public static getAndAccumulate(Ljava/util/concurrent/atomic/AtomicInteger;ILj$/util/function/IntBinaryOperator;)I
    .locals 3
    .param p0, "atomic"    # Ljava/util/concurrent/atomic/AtomicInteger;
    .param p1, "x"    # I
    .param p2, "accumulatorFunction"    # Lj$/util/function/IntBinaryOperator;
...
.method public static getAndUpdate(Ljava/util/concurrent/atomic/AtomicInteger;Lj$/util/function/IntUnaryOperator;)I
    .locals 3
    .param p0, "atomic"    # Ljava/util/concurrent/atomic/AtomicInteger;
    .param p1, "updateFunction"    # Lj$/util/function/IntUnaryOperator;
