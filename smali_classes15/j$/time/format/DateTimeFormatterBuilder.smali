...
.method private parseField(CILj$/time/temporal/TemporalField;)V
    ...
    invoke-virtual {p0, p3, v2, v2, v1}, Lj$/time/format/DateTimeFormatterBuilder;->appendValueReduced(Lj$/time/temporal/TemporalField;IILj$/time/chrono/ChronoLocalDate;)Lj$/time/format/DateTimeFormatterBuilder;
    ...
    invoke-virtual {p0, p3, p2, v2, v1}, Lj$/time/format/DateTimeFormatterBuilder;->appendValue(Lj$/time/temporal/TemporalField;IILj$/time/format/SignStyle;)Lj$/time/format/DateTimeFormatterBuilder;
    ...
    .line 1755
    :cond_c
    invoke-virtual {p0, p3, v2}, Lj$/time/format/DateTimeFormatterBuilder;->appendValue(Lj$/time/temporal/TemporalField;I)Lj$/time/format/DateTimeFormatterBuilder;
    ...
    invoke-direct {v1, p1, p2}, Lj$/time/format/DateTimeFormatterBuilder$WeekBasedFieldPrinterParser;-><init>(CI)V
...
.method private parsePattern(Ljava/lang/String;)V
    ...
    invoke-direct {v3, v1, v8}, Lj$/time/format/DateTimeFormatterBuilder$WeekBasedFieldPrinterParser;-><init>(CI)V
...
.method public appendZoneText(Lj$/time/format/TextStyle;Ljava/util/Set;)Lj$/time/format/DateTimeFormatterBuilder;
    ...
    invoke-direct {v0, p1, p2}, Lj$/time/format/DateTimeFormatterBuilder$ZoneTextPrinterParser;-><init>(Lj$/time/format/TextStyle;Ljava/util/Set;)V
