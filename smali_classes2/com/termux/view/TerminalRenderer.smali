...
.method private drawTextRun(Landroid/graphics/Canvas;[C[IFIIIIFIIJZ)V
    ...
    iget v6, v0, Lcom/termux/view/TerminalRenderer;->mFontWidth:F
    ...
    .end local v6    # "savedMatrix":Z
    .local v21, "foreColor":I
    .local p9, "savedMatrix":Z
    float-to-double v5, v11

    const-wide v22, 0x3f847ae147ae147bL    # 0.01

    cmpl-double v11, v5, v22
    ...
    invoke-virtual {v11, v5, v6}, Landroid/graphics/Canvas;->scale(FF)V
    ...
    .restart local v6    # "savedMatrix":Z
    goto :goto_6
    ...
    .local v31, "backColor":I
    move v4, v6

    move/from16 v7, v21

    .end local v21    # "foreColor":I
    ...
    .end local v31    # "backColor":I
    .restart local v4    # "backColor":I
    .restart local v6    # "right":F
    .restart local v21    # "foreColor":I
    :cond_b
    move/from16 v31, v4
    ...
    invoke-virtual/range {v22 .. v28}, Landroid/graphics/Canvas;->drawText([CIIFFLandroid/graphics/Paint;)V
...
.method public final render(Lcom/termux/terminal/TerminalEmulator;Landroid/graphics/Canvas;IIIII)V
    ...
    .local v7, "charsForCodePoint":I
    .local v43, "codePoint":I
    invoke-virtual {v0, v10, v11, v7}, Landroid/graphics/Paint;->measureText([CII)F
    ...
    .end local v7    # "charsForCodePoint":I
    .end local v35    # "screen":Lcom/termux/terminal/TerminalBuffer;
    .local v43, "screen":Lcom/termux/terminal/TerminalBuffer;
    .local v52, "charsForCodePoint":I
    ...
    .end local v47    # "line":[C
    .end local v52    # "charsForCodePoint":I
    ...
    .end local v43    # "screen":Lcom/termux/terminal/TerminalBuffer;
    ...
    .restart local v43    # "screen":Lcom/termux/terminal/TerminalBuffer;
