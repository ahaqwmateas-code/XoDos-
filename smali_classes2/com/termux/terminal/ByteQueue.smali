...
.method public declared-synchronized read([BZ)I
    ...
    iget-boolean v0, p0, Lcom/termux/terminal/ByteQueue;->mOpen:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget v7, p0, Lcom/termux/terminal/ByteQueue;->mStoredBytes:I
...
.method public write([BII)Z
    ...
    .line 93
    iget v4, p0, Lcom/termux/terminal/ByteQueue;->mHead:I
    ...
    .line 95
    .end local v4    # "oneRun":I
    :cond_3
    sub-int v4, v0, v3

    .line 97
    .restart local v4    # "oneRun":I
    :goto_5
    ...
    invoke-static {p1, p2, v6, v3, v5}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
