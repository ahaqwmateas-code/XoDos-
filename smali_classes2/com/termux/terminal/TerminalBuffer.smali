...
.method private blockCopyLinesDown(II)V
    ...
    iget-object v6, p0, Lcom/termux/terminal/TerminalBuffer;->mLines:[Lcom/termux/terminal/TerminalRow;
...
.method public clearTranscript()V
    ...
    iget v4, p0, Lcom/termux/terminal/TerminalBuffer;->mScreenFirstRow:I

    add-int/2addr v1, v4

    iget v4, p0, Lcom/termux/terminal/TerminalBuffer;->mActiveTranscriptRows:I

    sub-int/2addr v1, v4

    iget v4, p0, Lcom/termux/terminal/TerminalBuffer;->mTotalRows:I

    invoke-static {v0, v1, v4, v3}, Ljava/util/Arrays;->fill([Ljava/lang/Object;IILjava/lang/Object;)V
...
.method public resize(III[IJZ)V
    ...
    .line 212
    :cond_0
    invoke-virtual {v6, v1}, Lcom/termux/terminal/TerminalBuffer;->externalToInternalRow(I)I
    ...
    .line 219
    iget v1, v6, Lcom/termux/terminal/TerminalBuffer;->mActiveTranscriptRows:I
    ...
    .line 227
    .end local v1    # "actualShift":I
    :cond_6
    :goto_3
    iget v1, v6, Lcom/termux/terminal/TerminalBuffer;->mScreenFirstRow:I

    add-int/2addr v1, v0

    iput v1, v6, Lcom/termux/terminal/TerminalBuffer;->mScreenFirstRow:I
    ...
    :goto_5
    iput v1, v6, Lcom/termux/terminal/TerminalBuffer;->mActiveTranscriptRows:I
    ...
    .line 233
    .end local v0    # "shiftDownOfTopRow":I
    const/4 v2, 0x0
    ...
    .line 256
    .local v18, "currentOutputExternalRow":I
    const/16 v19, 0x0

    .line 261
    .local v19, "currentOutputExternalColumn":I
    const/16 v20, 0x0

    .line 262
    .local v20, "skippedBlankLines":I
    neg-int v12, v15

    move/from16 v7, v20

    .end local v20    # "skippedBlankLines":I
    ...
    .end local v18    # "currentOutputExternalRow":I
    .local v2, "currentOutputExternalRow":I
    .local v3, "i":I
    .local v22, "oldCursorRow":I
    .local v23, "oldTotalRows":I
    :goto_a
    if-ge v3, v7, :cond_10
    ...
    .end local v24    # "oldScreenFirstRow":I
    .end local v25    # "oldScreenRows":I
    ...
    .end local v4    # "oldScreenFirstRow":I
    .end local v5    # "oldScreenRows":I
    .restart local v24    # "oldScreenFirstRow":I
    .restart local v25    # "oldScreenRows":I
    const/4 v7, 0x0
    ...
    .line 273
    .end local v22    # "oldCursorRow":I
    .end local v23    # "oldTotalRows":I
    .end local v24    # "oldScreenFirstRow":I
    .end local v25    # "oldScreenRows":I
    .local v2, "oldTotalRows":I
    .local v3, "oldCursorRow":I
    .restart local v4    # "oldScreenFirstRow":I
    .restart local v5    # "oldScreenRows":I
    .restart local v18    # "currentOutputExternalRow":I
    :cond_11
    move/from16 v23, v2
    ...
    .end local v4    # "oldScreenFirstRow":I
    .end local v5    # "oldScreenRows":I
    .restart local v22    # "oldCursorRow":I
    .restart local v23    # "oldTotalRows":I
    .restart local v24    # "oldScreenFirstRow":I
    .restart local v25    # "oldScreenRows":I
    :goto_c
    const/4 v2, 0x0
    ...
    .end local v26    # "lastNonSpaceIndex":I
    .restart local v2    # "lastNonSpaceIndex":I
    goto :goto_e

    .line 295
    .end local v2    # "lastNonSpaceIndex":I
    .restart local v26    # "lastNonSpaceIndex":I
    :cond_13
    move/from16 v2, v26
    ...
    .local v17, "newCursorColumn":I
    .local v18, "newCursorPlaced":Z
    :goto_11
    if-ge v3, v4, :cond_20
    ...
    .end local v29    # "lastNonSpaceIndex":I
    .restart local v4    # "lastNonSpaceIndex":I
    :cond_17
    move/from16 v29, v4

    .end local v4    # "lastNonSpaceIndex":I
    .restart local v29    # "lastNonSpaceIndex":I
    move/from16 v30, v3
    ...
    .local v33, "currentOutputExternalRow":I
    .local v34, "currentOutputExternalColumn":I
    :goto_14
    if-gtz v22, :cond_1c
    ...
    .line 322
    .local v35, "offsetDueToCombiningChar":I
    sub-int v36, v34, v35

    .line 323
    .local v36, "outputColumn":I
    move-object/from16 v0, p0
    ...
    .end local v32    # "oldCursorRow":I
    .local v7, "currentOldCol":I
    .local v9, "oldCursorRow":I
    .local v37, "skippedBlankLines":I
    ...
    .line 331
    .end local v0    # "newCursorRow":I
    .restart local v19    # "newCursorRow":I
    :cond_1d
    move/from16 v0, v19
    ...
    .line 333
    .end local v34    # "currentOutputExternalColumn":I
    .local v19, "currentOutputExternalColumn":I
    if-eqz v26, :cond_1f
    ...
    .local v19, "newCursorRow":I
    .restart local v34    # "currentOutputExternalColumn":I
    :cond_1e
    move v5, v7
    ...
    .end local v7    # "currentOldCol":I
    .end local v22    # "displayWidth":I
    .end local v31    # "c":C
    .end local v34    # "currentOutputExternalColumn":I
    .end local v35    # "offsetDueToCombiningChar":I
    .end local v36    # "outputColumn":I
    .restart local v0    # "newCursorRow":I
    .restart local v5    # "currentOldCol":I
    .local v19, "currentOutputExternalColumn":I
    :cond_1f
    ...
    .end local v29    # "lastNonSpaceIndex":I
    .end local v33    # "currentOutputExternalRow":I
    .end local v37    # "skippedBlankLines":I
    ...
    .restart local v29    # "lastNonSpaceIndex":I
    .restart local v37    # "skippedBlankLines":I
    :goto_17
    ...
    .end local v19    # "currentOutputExternalColumn":I
    ...
    .end local v20    # "internalOldRow":I
    .end local v21    # "cursorAtThisRow":Z
    .end local v26    # "justToCursor":Z
    .end local v27    # "styleAtCol":J
    .end local v29    # "lastNonSpaceIndex":I
    .restart local v19    # "currentOutputExternalColumn":I
    :cond_23
    move/from16 v7, v37
    ...
    .local v17, "newCursorPlaced":Z
    .local v18, "currentOutputExternalRow":I
    .restart local v20    # "internalOldRow":I
    .restart local v21    # "cursorAtThisRow":Z
    :cond_24
    move/from16 v23, v2
    ...
    .end local v17    # "newCursorPlaced":Z
    .end local v18    # "currentOutputExternalRow":I
    .end local v19    # "currentOutputExternalColumn":I
    .end local v23    # "oldTotalRows":I
    .end local v24    # "oldScreenFirstRow":I
