.class public Lcom/termux/shared/termux/settings/preferences/TermuxStylingAppSharedPreferences;
...
.method public static build(Landroid/content/Context;)Lcom/termux/shared/termux/settings/preferences/TermuxStylingAppSharedPreferences;
    .locals 2
    ...
    .line 38
    .local v0, "termuxStylingPackageContext":Landroid/content/Context;
    if-nez v0, :cond_0
    ...
    .line 41
    :cond_0
    new-instance v1, Lcom/termux/shared/termux/settings/preferences/TermuxStylingAppSharedPreferences;

    invoke-direct {v1, v0}, Lcom/termux/shared/termux/settings/preferences/TermuxStylingAppSharedPreferences;-><init>(Landroid/content/Context;)V

    return-object v1
.end method

.method public static build(Landroid/content/Context;Z)Lcom/termux/shared/termux/settings/preferences/TermuxStylingAppSharedPreferences;
    .locals 2
    .param p0, "context"    # Landroid/content/Context;
...
.method public getLogLevel(Z)I
    ...
    .line 65
    iget-object v2, p0, Lcom/termux/shared/termux/settings/preferences/TermuxStylingAppSharedPreferences;->mMultiProcessSharedPreferences:Landroid/content/SharedPreferences;
    ...
    .line 67
    :cond_0
    iget-object v2, p0, Lcom/termux/shared/termux/settings/preferences/TermuxStylingAppSharedPreferences;->mSharedPreferences:Landroid/content/SharedPreferences;
...
.method public setLogLevel(Landroid/content/Context;IZ)V
    ...
    .line 72
    iget-object v0, p0, Lcom/termux/shared/termux/settings/preferences/TermuxStylingAppSharedPreferences;->mSharedPreferences:Landroid/content/SharedPreferences;
