...
.method public static getErrorsListLogString(Lcom/termux/shared/shell/command/result/ResultData;)Ljava/lang/String;
    .locals 4
    .param p0, "resultData"    # Lcom/termux/shared/shell/command/result/ResultData;
    ...
    check-cast v2, Lcom/termux/shared/errors/Error;

    .line 182
    .local v2, "error":Lcom/termux/shared/errors/Error;
    invoke-virtual {v2}, Lcom/termux/shared/errors/Error;->isStateFailed()Z
    ...
    .line 185
    :cond_1
    invoke-static {v2}, Lcom/termux/shared/errors/Error;->getErrorLogString(Lcom/termux/shared/errors/Error;)Ljava/lang/String;
...
.method public static getErrorsListMarkdownString(Lcom/termux/shared/shell/command/result/ResultData;)Ljava/lang/String;
    .locals 4
    .param p0, "resultData"    # Lcom/termux/shared/shell/command/result/ResultData;
    ...
    .line 232
    :cond_1
    invoke-static {v2}, Lcom/termux/shared/errors/Error;->getErrorMarkdownString(Lcom/termux/shared/errors/Error;)Ljava/lang/String;
...
.method public static getErrorsListMinimalString(Lcom/termux/shared/shell/command/result/ResultData;)Ljava/lang/String;
    .locals 4
    .param p0, "resultData"    # Lcom/termux/shared/shell/command/result/ResultData;
    ...
    .line 250
    :cond_1
    invoke-static {v2}, Lcom/termux/shared/errors/Error;->getMinimalErrorString(Lcom/termux/shared/errors/Error;)Ljava/lang/String;
...
.method public static getResultDataMarkdownString(Lcom/termux/shared/shell/command/result/ResultData;)Ljava/lang/String;
    .locals 6
    .param p0, "resultData"    # Lcom/termux/shared/shell/command/result/ResultData;
    ...
    .line 204
    .local v0, "markdownString":Ljava/lang/StringBuilder;
    iget-object v1, p0, Lcom/termux/shared/shell/command/result/ResultData;->stdout:Ljava/lang/StringBuilder;
    ...
    .line 209
    :goto_0
    iget-object v1, p0, Lcom/termux/shared/shell/command/result/ResultData;->stderr:Ljava/lang/StringBuilder;
    ...
    iget-object v2, p0, Lcom/termux/shared/shell/command/result/ResultData;->stderr:Ljava/lang/StringBuilder;
    ...
    iget-object v3, p0, Lcom/termux/shared/shell/command/result/ResultData;->exitCode:Ljava/lang/Integer;
    ...
    invoke-static {p0}, Lcom/termux/shared/shell/command/result/ResultData;->getErrorsListMarkdownString(Lcom/termux/shared/shell/command/result/ResultData;)Ljava/lang/String;
...
.method public getErrCode()I
    ...
    check-cast v0, Lcom/termux/shared/errors/Error;

    invoke-virtual {v0}, Lcom/termux/shared/errors/Error;->getCode()Ljava/lang/Integer;
...
.method public declared-synchronized setStateFailed(ILjava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {p0, v0, p1, p2, v0}, Lcom/termux/shared/shell/command/result/ResultData;->setStateFailed(Ljava/lang/String;ILjava/lang/String;Ljava/util/List;)Z
    ...
    .line 87
    .end local p0    # "this":Lcom/termux/shared/shell/command/result/ResultData;
    .end local p1    # "code":I
...
.method public declared-synchronized setStateFailed(ILjava/lang/String;Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {p0, v1, p1, p2, v0}, Lcom/termux/shared/shell/command/result/ResultData;->setStateFailed(Ljava/lang/String;ILjava/lang/String;Ljava/util/List;)Z
...
.method public declared-synchronized setStateFailed(ILjava/lang/String;Ljava/util/List;)Z
    ...
    :try_start_0
    invoke-virtual {p0, v0, p1, p2, p3}, Lcom/termux/shared/shell/command/result/ResultData;->setStateFailed(Ljava/lang/String;ILjava/lang/String;Ljava/util/List;)Z
...
.method public declared-synchronized setStateFailed(Lcom/termux/shared/errors/Error;)Z
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, Lcom/termux/shared/shell/command/result/ResultData;->setStateFailed(Ljava/lang/String;ILjava/lang/String;Ljava/util/List;)Z
...
.method public declared-synchronized setStateFailed(Lcom/termux/shared/errors/Error;Ljava/util/List;)Z
    ...
    invoke-virtual {p0, v0, v1, v2, p2}, Lcom/termux/shared/shell/command/result/ResultData;->setStateFailed(Ljava/lang/String;ILjava/lang/String;Ljava/util/List;)Z
