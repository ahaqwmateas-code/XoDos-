...
.method private constructor <init>(Lj$/util/concurrent/ConcurrentHashMap;)V
    ...
    .local p1, "map":Lj$/util/concurrent/ConcurrentHashMap;, "Ljava/util/concurrent/ConcurrentHashMap<TK;Ljava/lang/Long;>;"
...
.method static synthetic lambda$accumulateAndGet$2(Lj$/util/function/LongBinaryOperator;JJ)J
    .locals 2
    .param p0, "accumulatorFunction"    # Lj$/util/function/LongBinaryOperator;
    .param p1, "x"    # J
    .param p3, "oldValue"    # J

    .line 181
    invoke-interface {p0, p3, p4, p1, p2}, Lj$/util/function/LongBinaryOperator;->applyAsLong(JJ)J
...
.method static synthetic lambda$getAndAccumulate$3(Lj$/util/function/LongBinaryOperator;JJ)J
    .locals 2
    .param p0, "accumulatorFunction"    # Lj$/util/function/LongBinaryOperator;
    .param p1, "x"    # J
    .param p3, "oldValue"    # J
...
.method static synthetic lambda$getAndUpdate$1(Ljava/util/concurrent/atomic/AtomicLong;Lj$/util/function/LongUnaryOperator;Ljava/lang/Object;Ljava/lang/Long;)Ljava/lang/Long;
    .locals 4
    .param p0, "holder"    # Ljava/util/concurrent/atomic/AtomicLong;
    .param p1, "updaterFunction"    # Lj$/util/function/LongUnaryOperator;
...
.method static synthetic lambda$updateAndGet$0(Lj$/util/function/LongUnaryOperator;Ljava/lang/Object;Ljava/lang/Long;)Ljava/lang/Long;
    .locals 2
    .param p0, "updaterFunction"    # Lj$/util/function/LongUnaryOperator;
    ...
    :goto_0
    invoke-interface {p0, v0, v1}, Lj$/util/function/LongUnaryOperator;->applyAsLong(J)J
...
# virtual methods
.method public accumulateAndGet(Ljava/lang/Object;JLj$/util/function/LongBinaryOperator;)J
    .locals 2
    .param p2, "x"    # J
    .param p4, "accumulatorFunction"    # Lj$/util/function/LongBinaryOperator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TK;J",
    ...
    invoke-direct {v0, p4, p2, p3}, Lcom/google/common/util/concurrent/AtomicLongMap$$ExternalSyntheticLambda3;-><init>(Lj$/util/function/LongBinaryOperator;J)V

    invoke-virtual {p0, p1, v0}, Lcom/google/common/util/concurrent/AtomicLongMap;->updateAndGet(Ljava/lang/Object;Lj$/util/function/LongUnaryOperator;)J
...
.method public addAndGet(Ljava/lang/Object;J)J
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/google/common/util/concurrent/AtomicLongMap;->accumulateAndGet(Ljava/lang/Object;JLj$/util/function/LongBinaryOperator;)J
...
.method public getAndAccumulate(Ljava/lang/Object;JLj$/util/function/LongBinaryOperator;)J
    .locals 2
    .param p2, "x"    # J
    .param p4, "accumulatorFunction"    # Lj$/util/function/LongBinaryOperator;
    .annotation system Ldalvik/annotation/Signature;
    ...
    invoke-direct {v0, p4, p2, p3}, Lcom/google/common/util/concurrent/AtomicLongMap$$ExternalSyntheticLambda9;-><init>(Lj$/util/function/LongBinaryOperator;J)V

    invoke-virtual {p0, p1, v0}, Lcom/google/common/util/concurrent/AtomicLongMap;->getAndUpdate(Ljava/lang/Object;Lj$/util/function/LongUnaryOperator;)J
...
.method public getAndAdd(Ljava/lang/Object;J)J
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/google/common/util/concurrent/AtomicLongMap;->getAndAccumulate(Ljava/lang/Object;JLj$/util/function/LongBinaryOperator;)J
...
.method public getAndUpdate(Ljava/lang/Object;Lj$/util/function/LongUnaryOperator;)J
    .locals 3
    .param p2, "updaterFunction"    # Lj$/util/function/LongUnaryOperator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TK;",
            "Lj$/util/function/LongUnaryOperator;",
            ")J"
        }
    .end annotation
    ...
    invoke-direct {v2, v0, p2}, Lcom/google/common/util/concurrent/AtomicLongMap$$ExternalSyntheticLambda4;-><init>(Ljava/util/concurrent/atomic/AtomicLong;Lj$/util/function/LongUnaryOperator;)V

    invoke-static {v1, p1, v2}, Lj$/util/concurrent/ConcurrentMap$-EL;->compute(Ljava/util/concurrent/ConcurrentMap;Ljava/lang/Object;Lj$/util/function/BiFunction;)Ljava/lang/Object;
...
.method public updateAndGet(Ljava/lang/Object;Lj$/util/function/LongUnaryOperator;)J
    .locals 2
    .param p2, "updaterFunction"    # Lj$/util/function/LongUnaryOperator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    invoke-direct {v1, p2}, Lcom/google/common/util/concurrent/AtomicLongMap$$ExternalSyntheticLambda6;-><init>(Lj$/util/function/LongUnaryOperator;)V

    invoke-static {v0, p1, v1}, Lj$/util/concurrent/ConcurrentMap$-EL;->compute(Ljava/util/concurrent/ConcurrentMap;Ljava/lang/Object;Lj$/util/function/BiFunction;)Ljava/lang/Object;
