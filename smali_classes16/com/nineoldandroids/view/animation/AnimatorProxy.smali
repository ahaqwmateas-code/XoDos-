...
.method private computeRect(Landroid/graphics/RectF;Landroid/view/View;)V
    ...
    .line 263
    iget-object v3, p0, Lcom/nineoldandroids/view/animation/AnimatorProxy;->mTempMatrix:Landroid/graphics/Matrix;
...
.method private invalidateAfterUpdate()V
    ...
    .line 242
    .local v1, "after":Landroid/graphics/RectF;
    ...
    .line 238
    .end local v1    # "after":Landroid/graphics/RectF;
    :cond_1
    :goto_0
    return-void
.end method
...
.method private transformMatrix(Landroid/graphics/Matrix;Landroid/view/View;)V
    ...
    .line 283
    .local v1, "h":F
    iget-boolean v2, p0, Lcom/nineoldandroids/view/animation/AnimatorProxy;->mHasPivot:Z
    ...
    iget v4, p0, Lcom/nineoldandroids/view/animation/AnimatorProxy;->mPivotX:F
    ...
    iget v3, p0, Lcom/nineoldandroids/view/animation/AnimatorProxy;->mPivotY:F
    ...
    .local v3, "pY":F
    :goto_1
    iget v5, p0, Lcom/nineoldandroids/view/animation/AnimatorProxy;->mRotationX:F

    .line 288
    .local v5, "rX":F
    iget v6, p0, Lcom/nineoldandroids/view/animation/AnimatorProxy;->mRotationY:F

    .line 289
    .local v6, "rY":F
    iget v7, p0, Lcom/nineoldandroids/view/animation/AnimatorProxy;->mRotationZ:F
    ...
    .line 291
    :cond_2
    iget-object v8, p0, Lcom/nineoldandroids/view/animation/AnimatorProxy;->mCamera:Landroid/graphics/Camera;

    .line 292
    .local v8, "camera":Landroid/graphics/Camera;
    ...
    invoke-virtual {v8, v9}, Landroid/graphics/Camera;->rotateZ(F)V

    .line 296
    invoke-virtual {v8, p1}, Landroid/graphics/Camera;->getMatrix(Landroid/graphics/Matrix;)V
    ...
    .line 302
    .end local v8    # "camera":Landroid/graphics/Camera;
    :cond_3
    iget v8, p0, Lcom/nineoldandroids/view/animation/AnimatorProxy;->mScaleX:F

    .line 303
    .local v8, "sX":F
    iget v9, p0, Lcom/nineoldandroids/view/animation/AnimatorProxy;->mScaleY:F
    ...
    .end local v11    # "sPY":F
    :cond_5
    iget v10, p0, Lcom/nineoldandroids/view/animation/AnimatorProxy;->mTranslationX:F

    iget v11, p0, Lcom/nineoldandroids/view/animation/AnimatorProxy;->mTranslationY:F
