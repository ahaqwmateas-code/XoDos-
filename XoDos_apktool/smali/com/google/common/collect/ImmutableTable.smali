...
.method static synthetic lambda$toImmutableTable$1(Lj$/util/function/Function;Lj$/util/function/Function;Lj$/util/function/Function;Lcom/google/common/collect/ImmutableTable$Builder;Ljava/lang/Object;)V
    .locals 3
    .param p0, "rowFunction"    # Lj$/util/function/Function;
    .param p1, "columnFunction"    # Lj$/util/function/Function;
    .param p2, "valueFunction"    # Lj$/util/function/Function;
    ...
    invoke-interface {p2, p4}, Lj$/util/function/Function;->apply(Ljava/lang/Object;)Ljava/lang/Object;
...
.method static synthetic lambda$toImmutableTable$5(Lj$/util/function/Function;Lj$/util/function/Function;Lj$/util/function/Function;Lj$/util/function/BinaryOperator;Lcom/google/common/collect/ImmutableTable$CollectorState;Ljava/lang/Object;)V
    .locals 3
    .param p0, "rowFunction"    # Lj$/util/function/Function;
    .param p1, "columnFunction"    # Lj$/util/function/Function;
    .param p2, "valueFunction"    # Lj$/util/function/Function;
    .param p3, "mergeFunction"    # Lj$/util/function/BinaryOperator;
    ...
    .line 112
    invoke-interface {p0, p5}, Lj$/util/function/Function;->apply(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    .line 113
    invoke-interface {p1, p5}, Lj$/util/function/Function;->apply(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    .line 114
    invoke-interface {p2, p5}, Lj$/util/function/Function;->apply(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    .line 111
    invoke-virtual {p4, v0, v1, v2, p3}, Lcom/google/common/collect/ImmutableTable$CollectorState;->put(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Lj$/util/function/BinaryOperator;)V

    return-void
.end method

.method static synthetic lambda$toImmutableTable$6(Lj$/util/function/BinaryOperator;Lcom/google/common/collect/ImmutableTable$CollectorState;Lcom/google/common/collect/ImmutableTable$CollectorState;)Lcom/google/common/collect/ImmutableTable$CollectorState;
    .locals 1
    ...
    .line 116
    invoke-virtual {p1, p2, p0}, Lcom/google/common/collect/ImmutableTable$CollectorState;->combine(Lcom/google/common/collect/ImmutableTable$CollectorState;Lj$/util/function/BinaryOperator;)Lcom/google/common/collect/ImmutableTable$CollectorState;
...
.method public static toImmutableTable(Lj$/util/function/Function;Lj$/util/function/Function;Lj$/util/function/Function;)Lj$/util/stream/Collector;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 68
    .local p0, "rowFunction":Lj$/util/function/Function;, "Ljava/util/function/Function<-TT;+TR;>;"
    .local p1, "columnFunction":Lj$/util/function/Function;, "Ljava/util/function/Function<-TT;+TC;>;"
    ...
    .line 71
    new-instance v0, Lcom/google/common/collect/ImmutableTable$$ExternalSyntheticLambda4;

    invoke-direct {v0}, Lcom/google/common/collect/ImmutableTable$$ExternalSyntheticLambda4;-><init>()V

    new-instance v1, Lcom/google/common/collect/ImmutableTable$$ExternalSyntheticLambda5;

    invoke-direct {v1, p0, p1, p2}, Lcom/google/common/collect/ImmutableTable$$ExternalSyntheticLambda5;-><init>(Lj$/util/function/Function;Lj$/util/function/Function;Lj$/util/function/Function;)V

    new-instance v2, Lcom/google/common/collect/ImmutableTable$$ExternalSyntheticLambda6;

    invoke-direct {v2}, Lcom/google/common/collect/ImmutableTable$$ExternalSyntheticLambda6;-><init>()V

    new-instance v3, Lcom/google/common/collect/ImmutableTable$$ExternalSyntheticLambda7;

    invoke-direct {v3}, Lcom/google/common/collect/ImmutableTable$$ExternalSyntheticLambda7;-><init>()V
...
.method public static toImmutableTable(Lj$/util/function/Function;Lj$/util/function/Function;Lj$/util/function/Function;Lj$/util/function/BinaryOperator;)Lj$/util/stream/Collector;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .local p1, "columnFunction":Lj$/util/function/Function;, "Ljava/util/function/Function<-TT;+TC;>;"
    .local p2, "valueFunction":Lj$/util/function/Function;, "Ljava/util/function/Function<-TT;+TV;>;"
    .local p3, "mergeFunction":Lj$/util/function/BinaryOperator;, "Ljava/util/function/BinaryOperator<TV;>;"
    const-string v0, "rowFunction"
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lcom/google/common/collect/ImmutableTable$$ExternalSyntheticLambda1;-><init>(Lj$/util/function/Function;Lj$/util/function/Function;Lj$/util/function/Function;Lj$/util/function/BinaryOperator;)V

    new-instance v2, Lcom/google/common/collect/ImmutableTable$$ExternalSyntheticLambda2;

    invoke-direct {v2, p3}, Lcom/google/common/collect/ImmutableTable$$ExternalSyntheticLambda2;-><init>(Lj$/util/function/BinaryOperator;)V

    new-instance v3, Lcom/google/common/collect/ImmutableTable$$ExternalSyntheticLambda3;

    invoke-direct {v3}, Lcom/google/common/collect/ImmutableTable$$ExternalSyntheticLambda3;-><init>()V
