...
.method public static flatteningToMultimap(Lj$/util/function/Function;Lj$/util/function/Function;Lj$/util/function/Supplier;)Lj$/util/stream/Collector;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .local p1, "valueFunction":Lj$/util/function/Function;, "Ljava/util/function/Function<-TT;+Ljava/util/stream/Stream<+TV;>;>;"
    .local p2, "multimapSupplier":Lj$/util/function/Supplier;, "Ljava/util/function/Supplier<TM;>;"
    invoke-static {p0}, Lcom/google/common/base/Preconditions;->checkNotNull(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/common/collect/Multimaps$$ExternalSyntheticLambda1;-><init>(Lj$/util/function/Function;Lj$/util/function/Function;)V

    new-instance v1, Lcom/google/common/collect/Multimaps$$ExternalSyntheticLambda2;

    invoke-direct {v1}, Lcom/google/common/collect/Multimaps$$ExternalSyntheticLambda2;-><init>()V

    const/4 v2, 0x0

    new-array v2, v2, [Lj$/util/stream/Collector$Characteristics;

    invoke-static {p2, v0, v1, v2}, Lj$/util/stream/Collector$-CC;->of(Lj$/util/function/Supplier;Lj$/util/function/BiConsumer;Lj$/util/function/BinaryOperator;[Lj$/util/stream/Collector$Characteristics;)Lj$/util/stream/Collector;
...
.method static synthetic lambda$flatteningToMultimap$2(Lj$/util/function/Function;Lj$/util/function/Function;Lcom/google/common/collect/Multimap;Ljava/lang/Object;)V
    .locals 4
    ...
    new-instance v3, Lcom/google/common/collect/Multimaps$$ExternalSyntheticLambda0;

    invoke-direct {v3, v1}, Lcom/google/common/collect/Multimaps$$ExternalSyntheticLambda0;-><init>(Ljava/util/Collection;)V

    invoke-interface {v2, v3}, Lj$/util/stream/Stream;->forEachOrdered(Lj$/util/function/Consumer;)V
...
.method static synthetic lambda$toMultimap$0(Lj$/util/function/Function;Lj$/util/function/Function;Lcom/google/common/collect/Multimap;Ljava/lang/Object;)V
    .locals 2
    .param p0, "keyFunction"    # Lj$/util/function/Function;
    .param p1, "valueFunction"    # Lj$/util/function/Function;
    .param p2, "multimap"    # Lcom/google/common/collect/Multimap;
...
.method public static toMultimap(Lj$/util/function/Function;Lj$/util/function/Function;Lj$/util/function/Supplier;)Lj$/util/stream/Collector;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 115
    new-instance v0, Lcom/google/common/collect/Multimaps$$ExternalSyntheticLambda3;

    invoke-direct {v0, p0, p1}, Lcom/google/common/collect/Multimaps$$ExternalSyntheticLambda3;-><init>(Lj$/util/function/Function;Lj$/util/function/Function;)V

    new-instance v1, Lcom/google/common/collect/Multimaps$$ExternalSyntheticLambda4;

    invoke-direct {v1}, Lcom/google/common/collect/Multimaps$$ExternalSyntheticLambda4;-><init>()V
