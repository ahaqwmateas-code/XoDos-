...
.method public forEachLine(Lj$/util/function/Consumer;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 384
    .local p1, "action":Lj$/util/function/Consumer;, "Ljava/util/function/Consumer<-Ljava/lang/String;>;"
    :try_start_0
    ...
    .end local v0    # "lines":Lj$/util/stream/Stream;, "Ljava/util/stream/Stream<Ljava/lang/String;>;"
    .end local p1    # "action":Lj$/util/function/Consumer;, "Ljava/util/function/Consumer<-Ljava/lang/String;>;"
    :try_start_3
    throw v1
    :try_end_3
    ...
    .line 387
    .restart local v0    # "lines":Lj$/util/stream/Stream;, "Ljava/util/stream/Stream<Ljava/lang/String;>;"
    .restart local p1    # "action":Lj$/util/function/Consumer;, "Ljava/util/function/Consumer<-Ljava/lang/String;>;"
    :catchall_1
    move-exception v2
...
.method public lines()Lj$/util/stream/Stream;
    ...
    .line 149
    invoke-static {v0}, Lcom/google/common/io/CharSource$$ExternalSyntheticAPIConversion0;->m(Ljava/io/BufferedReader;)Lj$/util/stream/Stream;

    move-result-object v1

    new-instance v2, Lcom/google/common/io/CharSource$$ExternalSyntheticLambda1;

    invoke-direct {v2, v0}, Lcom/google/common/io/CharSource$$ExternalSyntheticLambda1;-><init>(Ljava/io/BufferedReader;)V
