...
.method public final isEqualSidecarDeviceState(Landroidx/window/sidecar/SidecarDeviceState;Landroidx/window/sidecar/SidecarDeviceState;)Z
    ...
    sget-object v3, Landroidx/window/SidecarAdapter;->Companion:Landroidx/window/SidecarAdapter$Companion;

    invoke-virtual {v3, p2}, Landroidx/window/SidecarAdapter$Companion;->getSidecarDevicePosture$window_release(Landroidx/window/sidecar/SidecarDeviceState;)I
...
.method public final isEqualSidecarWindowLayoutInfo(Landroidx/window/sidecar/SidecarWindowLayoutInfo;Landroidx/window/sidecar/SidecarWindowLayoutInfo;)Z
    ...
    invoke-virtual {v1, p2}, Landroidx/window/SidecarAdapter$Companion;->getSidecarDisplayFeatures(Landroidx/window/sidecar/SidecarWindowLayoutInfo;)Ljava/util/List;

    move-result-object v1

    .line 90
    .local v1, "secondDisplayFeatures":Ljava/util/List;
    invoke-direct {p0, v0, v1}, Landroidx/window/SidecarAdapter;->isEqualSidecarDisplayFeatures(Ljava/util/List;Ljava/util/List;)Z
...
.method public final translate(Landroidx/window/sidecar/SidecarWindowLayoutInfo;Landroidx/window/sidecar/SidecarDeviceState;)Landroidx/window/WindowLayoutInfo;
    ...
    invoke-virtual {v2, v0, v1}, Landroidx/window/SidecarAdapter$Companion;->setSidecarDevicePosture(Landroidx/window/sidecar/SidecarDeviceState;I)V

    .line 52
    sget-object v2, Landroidx/window/SidecarAdapter;->Companion:Landroidx/window/SidecarAdapter$Companion;

    invoke-virtual {v2, p1}, Landroidx/window/SidecarAdapter$Companion;->getSidecarDisplayFeatures(Landroidx/window/sidecar/SidecarWindowLayoutInfo;)Ljava/util/List;

    move-result-object v2

    .line 53
    .local v2, "sidecarDisplayFeatures":Ljava/util/List;
    invoke-virtual {p0, v2, v0}, Landroidx/window/SidecarAdapter;->translate(Ljava/util/List;Landroidx/window/sidecar/SidecarDeviceState;)Ljava/util/List;
