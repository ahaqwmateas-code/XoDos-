...
.method public validateExtensionInterface()Z
    ...
    .line 65
    .local v1, "methodSetExtensionCallback":Ljava/lang/reflect/Method;
    :goto_1
    if-nez v1, :cond_2
    ...
    invoke-direct {v9, v0, v0, v10, v0}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    .line 97
    invoke-direct {v8, v9, v2, v2}, Landroidx/window/extensions/ExtensionFoldingFeature;-><init>(Landroid/graphics/Rect;II)V
    ...
    const-string/jumbo v14, "windowLayoutInfo.displayFeatures"
    ...
    .line 117
    .local v0, "tmpDisplayFeatures":Ljava/util/List;
    const/4 v0, 0x1

    .end local v0    # "tmpDisplayFeatures":Ljava/util/List;
    .end local v1    # "methodSetExtensionCallback":Ljava/lang/reflect/Method;
    ...
    .line 90
    .restart local v1    # "methodSetExtensionCallback":Ljava/lang/reflect/Method;
    ...
    .line 90
    invoke-direct {v2, v8}, Ljava/lang/NoSuchMethodException;-><init>(Ljava/lang/String;)V
