...
.method private start(Z)V
    ...
    invoke-virtual {p0, v2, v3}, Lcom/nineoldandroids/animation/ValueAnimator;->setCurrentPlayTime(J)V
    ...
    .line 942
    .local v1, "animationHandler":Lcom/nineoldandroids/animation/ValueAnimator$AnimationHandler;
    if-nez v1, :cond_1

    .line 943
    new-instance v2, Lcom/nineoldandroids/animation/ValueAnimator$AnimationHandler;

    const/4 v3, 0x0

    invoke-direct {v2, v3}, Lcom/nineoldandroids/animation/ValueAnimator$AnimationHandler;-><init>(Lcom/nineoldandroids/animation/ValueAnimator$1;)V
    ...
    .line 918
    .end local v1    # "animationHandler":Lcom/nineoldandroids/animation/ValueAnimator$AnimationHandler;
    :cond_2
...
.method animateValue(F)V
    ...
    invoke-virtual {v2, p1}, Lcom/nineoldandroids/animation/PropertyValuesHolder;->calculateValue(F)V
...
.method animationFrame(J)Z
    ...
    .line 1104
    iget-wide v5, p0, Lcom/nineoldandroids/animation/ValueAnimator;->mSeekTime:J
    ...
    iput-wide v5, p0, Lcom/nineoldandroids/animation/ValueAnimator;->mStartTime:J

    .line 1109
    const-wide/16 v5, -0x1

    iput-wide v5, p0, Lcom/nineoldandroids/animation/ValueAnimator;->mSeekTime:J
    ...
    .line 1117
    iget v3, p0, Lcom/nineoldandroids/animation/ValueAnimator;->mCurrentIteration:I

    iget v5, p0, Lcom/nineoldandroids/animation/ValueAnimator;->mRepeatCount:I

    if-lt v3, v5, :cond_4

    iget v3, p0, Lcom/nineoldandroids/animation/ValueAnimator;->mRepeatCount:I
    ...
    .line 1122
    iget-object v6, p0, Lcom/nineoldandroids/animation/ValueAnimator;->mListeners:Ljava/util/ArrayList;
    ...
    invoke-interface {v6, p0}, Lcom/nineoldandroids/animation/Animator$AnimatorListener;->onAnimationRepeat(Lcom/nineoldandroids/animation/Animator;)V
    ...
    .end local v5    # "i":I
    :cond_5
    iget v3, p0, Lcom/nineoldandroids/animation/ValueAnimator;->mRepeatMode:I
    ...
    .line 1126
    iget-boolean v3, p0, Lcom/nineoldandroids/animation/ValueAnimator;->mPlayingBackwards:Z
    ...
    .line 1139
    :cond_8
    invoke-virtual {p0, v2}, Lcom/nineoldandroids/animation/ValueAnimator;->animateValue(F)V
...
.method public clone()Lcom/nineoldandroids/animation/ValueAnimator;
    ...
    .line 1188
    .local v1, "oldListeners":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/nineoldandroids/animation/ValueAnimator$AnimatorUpdateListener;>;"
    ...
    .line 1191
    iget-object v4, v0, Lcom/nineoldandroids/animation/ValueAnimator;->mUpdateListeners:Ljava/util/ArrayList;
    ...
    .line 1194
    .end local v1    # "oldListeners":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/nineoldandroids/animation/ValueAnimator$AnimatorUpdateListener;>;"
    .end local v2    # "numListeners":I
    .end local v3    # "i":I
    :cond_0
    const-wide/16 v1, -0x1

    iput-wide v1, v0, Lcom/nineoldandroids/animation/ValueAnimator;->mSeekTime:J
    ...
    .line 1201
    .local v1, "oldValues":[Lcom/nineoldandroids/animation/PropertyValuesHolder;
    if-eqz v1, :cond_1
    ...
    new-array v3, v2, [Lcom/nineoldandroids/animation/PropertyValuesHolder;

    iput-object v3, v0, Lcom/nineoldandroids/animation/ValueAnimator;->mValues:[Lcom/nineoldandroids/animation/PropertyValuesHolder;
    ...
    iput-object v3, v0, Lcom/nineoldandroids/animation/ValueAnimator;->mValuesMap:Ljava/util/HashMap;
    ...
    .line 1207
    .local v4, "newValuesHolder":Lcom/nineoldandroids/animation/PropertyValuesHolder;
    ...
    .line 1205
    .end local v4    # "newValuesHolder":Lcom/nineoldandroids/animation/PropertyValuesHolder;
    add-int/lit8 v3, v3, 0x1
...
.method public varargs setFloatValues([F)V
    ...
    .line 405
    .end local v0    # "valuesHolder":Lcom/nineoldandroids/animation/PropertyValuesHolder;
    :cond_2
    :goto_0
    const/4 v0, 0x1
