...
.method public static doubleStream(Lj$/util/function/Supplier;IZ)Lj$/util/stream/DoubleStream;
    .locals 2
    ...
    .line 314
    .local p0, "supplier":Lj$/util/function/Supplier;, "Ljava/util/function/Supplier<+Ljava/util/Spliterator$OfDouble;>;"
    new-instance v0, Lj$/util/stream/DoublePipeline$Head;
    ...
    invoke-direct {v0, p0, v1, p2}, Lj$/util/stream/DoublePipeline$Head;-><init>(Lj$/util/function/Supplier;IZ)V
...
.method public static intStream(Lj$/util/function/Supplier;IZ)Lj$/util/stream/IntStream;
    .locals 2
    .param p1, "characteristics"    # I
    .param p2, "parallel"    # Z
    .annotation system Ldalvik/annotation/Signature;
    ...
    .line 178
    .local p0, "supplier":Lj$/util/function/Supplier;, "Ljava/util/function/Supplier<+Ljava/util/Spliterator$OfInt;>;"
    new-instance v0, Lj$/util/stream/IntPipeline$Head;
    ...
    invoke-direct {v0, p0, v1, p2}, Lj$/util/stream/IntPipeline$Head;-><init>(Lj$/util/function/Supplier;IZ)V
...
.method public static longStream(Lj$/util/function/Supplier;IZ)Lj$/util/stream/LongStream;
    .locals 2
    .param p1, "characteristics"    # I
    .param p2, "parallel"    # Z
    .annotation system Ldalvik/annotation/Signature;
    ...
    .line 246
    .local p0, "supplier":Lj$/util/function/Supplier;, "Ljava/util/function/Supplier<+Ljava/util/Spliterator$OfLong;>;"
    new-instance v0, Lj$/util/stream/LongPipeline$Head;
    ...
    invoke-direct {v0, p0, v1, p2}, Lj$/util/stream/LongPipeline$Head;-><init>(Lj$/util/function/Supplier;IZ)V
...
.method public static stream(Lj$/util/function/Supplier;IZ)Lj$/util/stream/Stream;
    ...
    .line 110
    .local p0, "supplier":Lj$/util/function/Supplier;, "Ljava/util/function/Supplier<+Ljava/util/Spliterator<TT;>;>;"
    invoke-static {p0}, Lj$/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, v1, p2}, Lj$/util/stream/ReferencePipeline$Head;-><init>(Lj$/util/function/Supplier;IZ)V
